...
if vim.fn.executable("plantuml") == 1 then
  ...
  quickrun_config["plantuml"] = {
    type = "plantuml/svg",
  }

  -- svg 出力
  quickrun_config["plantuml/svg"] = {
    ["hook/cd/directory"] = "%S:p:h",
    outputter = "browser",
    exec = (vim.fn.has("win32") == 1 or vim.fn.has("win64") == 1) and "type %s | plantuml -tsvg -charset UTF-8 -pipe"
      or "cat %s | plantuml -tsvg -charset UTF-8 -pipe",
  }
